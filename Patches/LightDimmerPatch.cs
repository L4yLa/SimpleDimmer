...
namespace SimpleDimmer.Patches
{
    ...
    internal static class LightDimmerPatch
    {
        ...
        private static void BloomPrePassBackgroundColorsGradientTintColorWithLightIds_ColorWasSet(ref Color color) =>
